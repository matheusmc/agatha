package br.gov.mpog.gestaoriscos.features.pageobjects.desenhocontrole;
 ...
 */
@DefaultUrl("/")
public class DesenhoControlePO extends ComumPO {
    ...
    public DesenhoControlePO(WebDriver driver) {
        super(driver);
    }

    public void acessarPagina() {
        autenticacaoOpenAmPO.acessarPagina("/manterDesenho");
