package br.gov.mpog.gestaoriscos.features.pageobjects.manterconsequenciadeeventoderisco;
...
public class ManterConsequenciaDeEventoDeRiscoPO extends ComumPO {
    public ManterConsequenciaDeEventoDeRiscoPO(final WebDriver driver) {
        super(driver);
    }

    public ManterConsequenciaDeEventoDeRiscoPO(WebDriver driver, int ajaxTimeout) {
    ...
    public void acessarPagina() {
        autenticacaoOpenAmPO.acessarPagina("/manterConsequenciaEventoRisco");
    }
    ...
    public void incluirRisco() {
        ...
        campoDescricao.typeAndTab("Descricao de Consequencia de Evento");
        loading.waitUntilNotVisible();
    ...
    public void eInformouOsParametrosExistentes() {
        ...
        campoDescricao.waitUntilClickable().typeAndTab("Descricao de Consequencia de Evento");
    }
