package br.gov.mpog.gestaoriscos.features.pageobjects.mantercontrole;
...
public class ManterControlePO extends ComumPO {

    public ManterControlePO(WebDriver driver) {
        super(driver);
    }
    ...
    public void acessarPagina() {
        autenticacaoOpenAmPO.acessarPagina("/manterControle");
    }
    ...
    public void incluirRisco() {
        ...
        campoDescricao.typeAndTab("Descricao do Controle");
        loading.waitUntilNotVisible();
    ...
    public void eInformouOsParametrosExistentes() {
        ...
        campoDescricao.waitUntilClickable().typeAndTab("Descricao do Controle");
    }
