package br.gov.mpog.gestaoriscos.features.pageobjects.mantereventoderisco;
 ...
 */
public class ManterEventoDeRiscoPO extends ComumPO {

    public ManterEventoDeRiscoPO(final WebDriver driver) {
        super(driver);
    }
    ...
    public void acessarPagina() {
        autenticacaoOpenAmPO.acessarPagina("/manterEventoRisco");
    }
    ...
    public void incluirRisco() {
        ...
        campoDescricao.typeAndTab("Descricao do Evento");
        loading.waitUntilNotVisible();
    ...
    public void eInformouOsParametrosExistentes() {
        ...
        campoDescricao.waitUntilClickable().typeAndTab("Descricao do Evento");
    }
