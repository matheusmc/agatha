 ...
 */
public class CalculoRiscoTest {

    CalculoRisco calculoRisco;

    @Before
    public void setUp() throws Exception {
        calculoRisco = new CalculoRisco();
    }
    ...
    public void getEventoRisco() throws Exception {
        ...
        calculoRisco.setEventoRisco(eventoRisco);
        assertEquals(eventoRisco, calculoRisco.getEventoRisco());
    }
