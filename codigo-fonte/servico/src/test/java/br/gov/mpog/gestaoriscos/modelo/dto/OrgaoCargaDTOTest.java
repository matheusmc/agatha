 ...
 */
public class OrgaoCargaDTOTest {
    ...
    @Test
    public void orgaoEmpty() throws Exception {
        orgaoCarga.setCodigoUnidade("");
        orgaoCarga.setCodigoUnidadePai("");

        Orgao orgao = orgaoCarga.orgao();

        assertEquals(null, orgao.getId());
        assertEquals(null, orgao.getOrgaoPai().getId());
    }
