...
Funcionalidade: US014 Manter Evento de Risco

  Como usuário autenticado no sistema, com o perfil núcleo
  Preciso consultar, incluir, alterar e excluir Evento de Risco
  Para utilizar os dados na funcionalidade identificação de eventos de risco

  Cenário: Critério 01: Menu Evento de Risco
    Dado que o usuário esteja em menu do sistema
    Quando o usuário acionar a opção "Evento de Risco"
  ...
  Cenário: Critério 02: Incluir Evento de Risco
  ...
  Cenário: Critério 03: Concluir inclusão e evento de risco
    Dado que o usuário esteja em evento de risco
  ...
  Cenário: Critério 05: Alterar Evento de Risco
  ...
  Cenário: Critério 07: Ativar Evento de Risco
  ...
  Cenário: Critério 08: Inativar Evento de Risco
    Dado que o usuário esteja em lista de Eventos de Risco
  ...
  Cenário: Critério 09: Excluir Evento de Risco
    Dado que o usuário esteja em lista de Eventos de Risco
  ...
  Cenário: Critério 10: Confirmar Exclusão de Evento de Risco
